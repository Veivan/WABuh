...
public class TokenMap {
	...
	public void GetToken(int token) throws Exception
	{
		String[] array = null;
		if (!this.subdict && token >= 236 && token < (236 + this.secondaryStrings.length)) {
			this.subdict = true;
		}

		if (this.subdict) 
			array = this.secondaryStrings;
		else 
			array = this.primaryStrings;

		if (token < 0 || token > array.length) {
			throw new Exception("Invalid token " + token);
		}

		this.str = array[token];
		if (this.str == null)
		{
	...
	public boolean TryGetToken(String str)
	{
